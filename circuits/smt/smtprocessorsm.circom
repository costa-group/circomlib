...
template SMTProcessorSM() {
  ...
  spec_postcondition (levIns == 1 && is0 == 1 && fnc[0] == 1) => st_old0 == prev_top;
  ...
  //Possible bug: it does not prove that st_new == prev_top under its conditions.
  //spec_postcondition (levIns == 1 && is0 == 0 && fnc[0] == 1 && xor == 1) => st_new1 == prev_top;
  spec_postcondition ((is0 == 1 || levIns == 0 || fnc[0] == 0) && xor == 1) => st_new1 == prev_bot;
  ...
  spec_postcondition ((is0 == 1 || levIns == 0 || fnc[0] == 0) && xor == 0) => st_bot == prev_bot;
  //Possible bug: I believe it should be st_bot == prev_top  isntead of st_bot == prev_top + prev_bot
  spec_postcondition (levIns == 1 && is0 == 0 && fnc[0] == 1 && xor == 0) => st_bot == prev_top + prev_bot;
  ...
  //      - prev_top * levIns * fnc[0]
  st_upd <== aux1 - aux2;
  spec_postcondition (levIns == 1 && fnc[0] == 0) => st_upd == prev_top;
  ...
  st_na <== prev_new1 + prev_old0 + prev_na + prev_upd;
  //Possible bug:
  //spec_postcondition st_na == prev_new1 + prev_old0 + prev_na + prev_upd;
}


template main_processorsm(){
    signal input xor;
    signal input is0;
    signal input levIns;
    signal input fnc[2];
  ...
  signal input prev_na;
  signal input prev_upd;
    (_,_,_,_,_,_) <== SMTProcessorSM()(AddBinaryTag()(xor),AddBinaryTag()(is0),AddBinaryTag()(levIns),AddBinaryArrayTag(2)(fnc), prev_top, prev_old0, prev_bot, prev_new1, prev_na, prev_upd);
}

//component main = main_processorsm();